...
import { fetchACProductDetails } from '../../services/allApi'; 
...
export default function ACForm() {
  ...
  useEffect(() => {
    fetchACProductDetails()
      ...
      .catch(error => {
        console.error("Error fetching AC services and brands:", error);
        setLoading(false); 
      });
  }, []);
  ...
  const handleContinue = () => {
    navigate('/contact-ac', { state: formData });
  };
