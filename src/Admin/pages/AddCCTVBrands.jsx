...
import { addACCCTVBrands, deleteACCCTVBrands, getCCTVBrands, updateACCCTVBrands } from '../../services/allApi';
...
const AddCCTVBrand = () => {
  ...
  useEffect(() => {
    const fetchBrands = async () => {
      try {
        const response = await getCCTVBrands();
